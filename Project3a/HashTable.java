...
//
/////////////////////////////// 80 COLUMNS WIDE ///////////////////////////////
/Users/apple/Desktop/Comp sci 400/project/p3a/src/HashTable.java
 ...
 * numKeys and an array table which is the hash table created.
 *
 * @param <K>  key
 * @param <V> value
 */
public class HashTable<K extends Comparable<K>, V> implements HashTableADT<K, V> {
  ...
  private void resize() {
    ...
    Node<K, V>[] newtable = new Node[table.length * 2 + 1];
  ...
  public void insert(K key, V value) throws IllegalNullKeyException {
    ...
    if (list == null) {// if list is null
      if (getLoadFactor() >= getLoadFactorThreshold()) {// when almost full resize
        resize();
      }
...
//    for (int i = 0; i < table.length; i++) {
//      if (key.equals(table[bucket].key)) {
//        table[bucket].value = value;
//        return  ;
//      } 
//    }
